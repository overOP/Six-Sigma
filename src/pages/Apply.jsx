...
const Apply = () => {
  ...
  return (
    <div className="min-h-screen pt-30 px-4 bg-linear-to-br from-slate-50 via-blue-50 to-indigo-100">
      <div className="max-w-6xl mx-auto rounded-3xl border border-gray-300 overflow-hidden">
        {/* Header */}
        <div className="bg-white">
          <div className="bg-linear-to-r from-blue-900 via-indigo-800 to-blue-800 text-white py-12 px-6 text-center">
            <h1 className="text-4xl font-extrabold">
              <span className="text-emerald-400">Six</span>
          ...
          <div className="px-10 py-14">
            <h2 className="text-3xl font-bold text-center text-gray-800 ">
              <span className="text-emerald-600">Admission </span>
               <span className="text-indigo-600">Application</span> Form
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-16">
              {/* Personal Details */}
              <Section title="Personal Details" color="bg-indigo-600">
              ...
              <Section title="Attach Your Documents" color="bg-blue-700">
                <div className="grid md:grid-cols-4 gap-8">
                  ...
                  />
                  <FileUpload
                    label="Character Certificate 10th"
                    name="character10"
                    onChange={handleFileChange}
                    file={documents.character10}
                  />
                  <FileUpload
                    label="School Leaving Certificate 10th"
                    name="leaving10"
                    onChange={handleFileChange}
                  ...
                  />
                  <FileUpload
                    label="School Leaving Certificate +2"
                    name="leaving12"
                    onChange={handleFileChange}
              ...
              <div className="flex justify-center pt-10">
                <button
                  type="submit"
                  className="px-12 py-4 rounded-2xl font-semibold text-white bg-emerald-500 hover:bg-emerald-600 transition cursor-pointer"
                >
                  Submit Application
                </button>
              </div>
