    ...
    >
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:block">
          <Link to="/contact">
            <button className="bg-blue-600 text-white px-6 py-2 rounded-full shadow-md hover:bg-gradient-to-r hover:from-green-500 hover:to-blue-600 hover:shadow-xl hover:scale-105 transition-all duration-300">
              Contact Us
            </button>
          </Link>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden px-6 pb-6 space-y-5 bg-white shadow-xl mx-2 rounded-b-2xl mt-2">
          ...
          <Link to="/contact">
            <button
              onClick={() => setIsOpen(false)}
              className="w-full bg-blue-600 text-white px-6 py-3 rounded-full shadow-md hover:bg-gradient-to-r hover:from-green-500 hover:to-blue-600 hover:shadow-xl hover:scale-105 transition-all duration-300"
            >
              Contact Us
            </button>
          </Link>
